...
return [
    ...
    'auth' => [
         ...
         */
        'extra_info' => '<strong>Bearer tokens are not required if calling the API from an SPA frontend, you must use the /sanctum/csrf-cookie & /api/login endpoints to authenticate SPA frontend apps. Token authentication is only used for mobile apps and testing the backend locally.</strong><br>
